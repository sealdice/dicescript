					...
					&choiceExpr{
						alternatives: []any{
							...
							&seqExpr{
								exprs: []any{
									&actionExpr{
										run:  (*parser).call_onfstring_82,
										expr: &litMatcher{val: "'", want: "\"'\""},
									},
									&actionExpr{
										run: (*parser).call_onfstring_84,
										expr: &seqExpr{
											exprs: []any{
												&zeroOrMoreExpr{
...
func (p *parser) call_onfstring_54() any {
	return (func(c *current) any {
		c.data.CounterAdd(1)
		return nil
	})(&p.cur)
...
func (p *parser) call_onfstring_63() any {
	return (func(c *current) any {
		c.data.CounterAdd(1)
		return nil
	})(&p.cur)
...
func (p *parser) call_onfstring_82() any {
	return (func(c *current) any {
		c.data.CounterPush()
		return nil
	})(&p.cur)
...
func (p *parser) call_onfstring_84() any {
	return (func(c *current) any {
		c.data.CounterPop()
		return nil
	})(&p.cur)
