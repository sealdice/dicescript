						...
						expr: &seqExpr{
							exprs: []any{
								&actionExpr{
									...
									expr: &ruleIRefExpr{index: 107 /* logicOr */},
								},
								&actionExpr{
		...
		},
		{
			...
			expr: &choiceExpr{
				alternatives: []any{
					...
					&ruleIRefExpr{index: 130 /* st_modify_multi_2 */},
				},
			},
		},
		{
					...
					&seqExpr{
						exprs: []any{
							&actionExpr{
								...
								expr: &andExpr{
									expr: &ruleIRefExpr{index: 123 /* e0 */},
								},
							},
							&actionExpr{
			...
			expr: &choiceExpr{
				alternatives: []any{
					&actionExpr{
						...
						expr: &seqExpr{
							exprs: []any{
								&ruleIRefExpr{index: 136 /* st_name2 */},
								&ruleIRefExpr{index: 115 /* sp */},
								&choiceExpr{
									alternatives: []any{
										&litMatcher{val: ":", want: "\":\""},
					...
					&actionExpr{
						...
						expr: &seqExpr{
							exprs: []any{
								&ruleIRefExpr{index: 134 /* st_name1 */},
								&ruleIRefExpr{index: 124 /* est */},
							},
						},
					},
					&actionExpr{
						...
						expr: &seqExpr{
							exprs: []any{
								&ruleIRefExpr{index: 137 /* st_name2r */},
								&ruleIRefExpr{index: 115 /* sp */},
					...
					&actionExpr{
						...
						expr: &seqExpr{
							exprs: []any{
								&ruleIRefExpr{index: 135 /* st_name1r */},
								&ruleIRefExpr{index: 124 /* est */},
							},
						},
					},
		...
		},
		{
			...
			expr: &seqExpr{
				exprs: []any{
							...
							&choiceExpr{
								alternatives: []any{
									&seqExpr{
										exprs: []any{
											&ruleIRefExpr{index: 136 /* st_name2 */},
											&ruleIRefExpr{index: 129 /* st_modify_rest1 */},
										},
									},
									&seqExpr{
										exprs: []any{
									...
									&seqExpr{
										exprs: []any{
											&ruleIRefExpr{index: 134 /* st_name1 */},
											&ruleIRefExpr{index: 133 /* st_modify_rest */},
										},
									},
									&seqExpr{
										exprs: []any{
					...
					&ruleIRefExpr{index: 131 /* st_modify_multi_rest */},
				},
			},
		},
		{
		...
		},
		{
			...
			expr: &seqExpr{
				exprs: []any{
					&seqExpr{
						exprs: []any{
							&ruleIRefExpr{index: 132 /* st_modify2 */},
							&ruleIRefExpr{index: 115 /* sp */},
							&zeroOrOneExpr{
								expr: &litMatcher{val: ",", want: "\",\""},
							},
			...
			expr: &actionExpr{
				...
				expr: &labeledExpr{
					...
					expr: &seqExpr{
						exprs: []any{
							&oneOrMoreExpr{
								expr: &ruleIRefExpr{index: 138 /* id_ch0 */},
							},
							&litMatcher{val: ":", want: "\":\""},
							&oneOrMoreExpr{
								expr: &ruleIRefExpr{index: 138 /* id_ch0 */},
