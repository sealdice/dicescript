			...
			expr: &actionExpr{
				...
				expr: &labeledExpr{
					...
					expr: &oneOrMoreExpr{
						expr: &choiceExpr{
							alternatives: []any{
								&ruleIRefExpr{index: 90 /* strEscape */},
								&ruleIRefExpr{index: 83 /* strPart1Normal */},
							},
						},
					},
				},
				...
				expr: &labeledExpr{
					...
					expr: &oneOrMoreExpr{
						expr: &choiceExpr{
							alternatives: []any{
								&ruleIRefExpr{index: 90 /* strEscape */},
								&ruleIRefExpr{index: 85 /* strPart2Normal */},
							},
						},
					},
				},
				...
				expr: &labeledExpr{
					...
					expr: &oneOrMoreExpr{
						expr: &choiceExpr{
							alternatives: []any{
								&ruleIRefExpr{index: 90 /* strEscape */},
								&ruleIRefExpr{index: 87 /* strPart3Normal */},
							},
						},
					},
				},
				...
				expr: &labeledExpr{
					...
					expr: &oneOrMoreExpr{
						expr: &choiceExpr{
							alternatives: []any{
								&ruleIRefExpr{index: 90 /* strEscape */},
								&ruleIRefExpr{index: 89 /* strPart4Normal */},
							},
						},
					},
				},
		...
		},
		{
			...
			expr: &seqExpr{
				exprs: []any{
					&litMatcher{val: "{", want: "\"{\""},
					&ruleIRefExpr{index: 122 /* sp */},
					&ruleIRefExpr{index: 91 /* fstringExpr1 */},
					&ruleIRefExpr{index: 122 /* sp */},
					&choiceExpr{
						alternatives: []any{
							&litMatcher{val: "}", want: "\"}\""},
								...
								exprs: []any{
									...
									&actionExpr{
										...
										expr: &seqExpr{
											exprs: []any{
												&zeroOrMoreExpr{
													expr: &ruleIRefExpr{index: 82 /* strPart1 */},
												},
												&litMatcher{val: "'", want: "\"'\""},
											},
										},
										...
										expr: &seqExpr{
											exprs: []any{
												&zeroOrMoreExpr{
													expr: &choiceExpr{
														alternatives: []any{
															&ruleIRefExpr{index: 86 /* strPart3 */},
															&ruleIRefExpr{index: 93 /* fstringStmt */},
															&ruleIRefExpr{index: 92 /* fstringExpr */},
														},
													},
												},
												&litMatcher{val: "`", want: "\"`\""},
										...
										expr: &seqExpr{
											exprs: []any{
												&zeroOrMoreExpr{
													expr: &choiceExpr{
														alternatives: []any{
															&ruleIRefExpr{index: 88 /* strPart4 */},
															&ruleIRefExpr{index: 93 /* fstringStmt */},
															&ruleIRefExpr{index: 92 /* fstringExpr */},
														},
													},
